 ...
 */
const LevelMeter = ({ rms, peak, rmsSmoothed, peakSmoothed, isAnalyzing, }) => {
    ...
    const peakHoldTimeout = useRef(null);
    ...
    const getRmsGradientColors = (rmsLevel) => {
        if (rmsLevel < 0.3) {
    ...
    return (React.createElement(View, { style: styles.container },
        React.createElement(View, { style: styles.rmsContainer },
        ...
        React.createElement(View, { style: [styles.peakContainer, { height: meterHeight }] },
            React.createElement(Animated.View, { style: [
                    styles.peakDot,
                    {
                        transform: [
            ...
            React.createElement(View, { style: styles.scaleMarkers }, [0.25, 0.5, 0.75, 1.0].map((level, index) => (React.createElement(View, { key: index, style: [
                    styles.scaleMarker,
                    {
