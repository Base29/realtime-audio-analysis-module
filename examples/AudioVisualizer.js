...
import { View, Text, TouchableOpacity, StyleSheet, Platform, PermissionsAndroid, Dimensions, SafeAreaView, } from 'react-native';
    ...
    return (React.createElement(SafeAreaView, { style: styles.container },
        ...
        React.createElement(View, { style: styles.meterContainer },
            ...
            React.createElement(Text, { style: styles.statText },
                ...
                peak.toFixed(3))),
        renderBars(),
        React.createElement(View, { style: styles.controls }, !isRecording ? (React.createElement(TouchableOpacity, { style: [styles.button, styles.startBtn], onPress: startAnalysis },
