...
class ReactNativeModuleLinkingCLI {
  constructor() {
    ...
    _defineProperty(this, "guideGenerator", void 0);
  ...
  printSummary(result, dryRun) {
    ...
    if (!dryRun && result.success) {
      var _result$androidResult, _result$iosResult;
      this.log('');
      this.log(chalk.blue('🚀 Next steps:'));
      if ((_result$androidResult = result.androidResult) !== null && _result$androidResult !== void 0 && _result$androidResult.success) {
        this.log(chalk.gray('   - For Android: Run "cd android && ./gradlew clean" to clean build cache'));
      }
      if ((_result$iosResult = result.iosResult) !== null && _result$iosResult !== void 0 && _result$iosResult.success) {
...
//# sourceMappingURL=cli.js.mapurceMappingURL=cli.js.map